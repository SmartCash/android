...
class LoginActivityTest2 {
    ...
    internal val NON_EXISTENT_EMAIL_ON_WEB_WALLET = "enriquesouza@protonmail.com"
    internal val EXISTENT_SMS_ON_WEB_WALLET = "+5511911111111"
    internal val NON_EXISTENT_SMS_ON_WEB_WALLET = "+5511982115286"
...
// app encerra apresentando mensagem "Smartcash parou" Abrir aplicativavo novamente.
    ...
    private fun sendCoins(withoutPin: Boolean = false) {
        ...
        sendTo(EXISTENT_EMAIL_ON_WEB_WALLET, withoutPin) //Should send directly to web smarthub account of the user

        sendTo(NON_EXISTENT_EMAIL_ON_WEB_WALLET, withoutPin) //Should use SmartText to send to email box

        sendTo(EXISTENT_SMS_ON_WEB_WALLET, withoutPin) //Should send directly to web smarthub account of the user

        sendTo(NON_EXISTENT_SMS_ON_WEB_WALLET, withoutPin) //Should use SmartText to send to SMS message

        sendTo(EXISTENT_USERNAME_ON_WEB_WALLET, withoutPin) //Should send directly to web smarthub account of the user

        sendTo(NON_EXISTENT_USERNAME_ON_WEB_WALLET, withoutPin) //Should get an error

        sendTo(VALID_ADDRESS, withoutPin) //Should send directly to web smarthub account of the user
